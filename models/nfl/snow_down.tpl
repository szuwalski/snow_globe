DATA_SECTION
 //Bering Sea snow crab model
  ...
  init_matrix prop_skip(styr,endyr,1,size_n)
  ...
  init_vector log_mu_m_mat_prior(1,2)
...
PARAMETER_SECTION
  ...
  init_bounded_number log_m_mu(1-5,3,est_log_m_mu)
  init_bounded_vector log_m_mat_mu(1,2,-5,3,est_log_m_mat_mu)
  ...
  init_bounded_number surv_sel_50(25,150,2)
  init_bounded_number surv_sel_slope(0.0001,20,2) 
  ...
  vector temp_skip(1,size_n)
  vector temp_noskip(1,size_n)
