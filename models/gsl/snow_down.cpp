...
model_data::model_data(int argc,char * argv[]) : ad_comm(argc,argv)
{
  ...
  skip_molt.allocate(styr,endyr,1,size_n,"skip_molt");
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  fish_ret_sel_50.allocate(25,150,2,"fish_ret_sel_50");
  fish_ret_sel_slope.allocate(0.0001,20,2,"fish_ret_sel_slope");
  ...
  #endif
  skip_imm.allocate(1,size_n,"skip_imm");
  #ifndef NO_AD_INITIALIZE
    skip_imm.initialize();
  #endif
